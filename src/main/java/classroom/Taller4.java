...
public class Taller4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Asignatura().nombre);//sin nombre
        System.out.println(grupo2.codigo);//10122
        System.out.println(asignatura2.codigoExterno);//882
        asignatura1.cambiarDatos(50);
        System.out.println(asignatura1.codigoExterno);//50
        System.out.println(estudiantes1[1].cedula);//0
